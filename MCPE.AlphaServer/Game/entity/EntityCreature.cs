...
namespace SpoongePE.Core.Game.entity
{
    public class EntityCreature : EntityLiving
    {
        ...
        protected new void updatePlayerActionState()
        {
            ...
            if (this.hasAttacked || this.playerToAttack == null || this.pathToEntity != null && this.rand.Next(20) != 0)
            {
                if (!this.hasAttacked && (this.pathToEntity == null && this.rand.Next(80) == 0 || this.rand.Next(80) == 0))
                {
            ...
            if (this.pathToEntity != null && this.rand.Next(100) != 0)
            {
                ...
                if (this.rand.NextSingle() < 0.8F && (var3 || var4))
                {
                    this.isJumping = true;
                }
        ...
        protected float getBlockPathWeight(int var1, int var2, int var3) => 0.0F;
        

        protected Entity findPlayerToAttack() => null;
        ...
        public new bool getCanSpawnHere()
        {
            ...
            return base.getCanSpawnHere() && this.getBlockPathWeight(var1, var2, var3) >= 0.0F;
        }

        public bool hasPath() => this.pathToEntity != null;
        

        public void setPathToEntity(PathEntity var1) => this.pathToEntity = var1;
        

        public Entity getTarget() => this.playerToAttack;
        

        public void setTarget(Entity var1) => this.playerToAttack = var1;
